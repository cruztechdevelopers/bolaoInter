...
<!-- For checkpoint task examples and patterns, see @C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
