...
See C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/discovery.md
...
Use C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/discovery.md.
