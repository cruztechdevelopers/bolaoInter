...
- **Global scope**: `C:/Projetos/Bolão Copa 2026/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Projetos/Bolão Copa 2026/.claude/notes/`)
...
2. Glob `C:/Projetos/Bolão Copa 2026/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Projetos/Bolão Copa 2026/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Projetos/Bolão Copa 2026/.claude/notes/` — works in any directory
