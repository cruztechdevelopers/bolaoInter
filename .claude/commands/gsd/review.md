...
<execution_context>
@C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/workflows/review.md
</execution_context>
...
<process>
Execute the review workflow from @C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/workflows/review.md end-to-end.
</process>
