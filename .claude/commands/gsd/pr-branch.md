...
<execution_context>
@C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
