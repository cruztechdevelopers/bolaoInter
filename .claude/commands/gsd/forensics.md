...
<execution_context>
@C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
