...
Use template from `C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
