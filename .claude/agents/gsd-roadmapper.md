...
Reference full template: `C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Projetos/Bolão Copa 2026/.claude/get-shit-done/templates/state.md`.
